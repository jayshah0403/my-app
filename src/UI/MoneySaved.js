...
import './MoneySaved.css';

const MoneySaved = () => {
    return (
        <div>
            <p className="text">Money saved over 20 years</p>
            ...
            <div className='prod-text'>
                <p className='prod-title'>$idk</p>
                <p className='prod-description'>This is the estimated amount you would save on your electric bill over 20 years.</p>
            </div>
        </div>
        </div>
    );
