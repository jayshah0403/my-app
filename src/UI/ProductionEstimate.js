...
import './ProductionEstimate.css';

const ProductionEstimate = () => {
    return (
        <div>
            <p className="text">Annual production estimate</p>
            <div className="prod-section">
            <div className="prod-icon-container">
            ...
            <div className='prod-text'>
                <p className='prod-title'>10,000 kWh</p>
                <p className='prod-description'>This is the amount of electricity your solar panels are expected to produce each year based on your location and roof size.</p>
            </div>
        </div>
        </div>
    );
